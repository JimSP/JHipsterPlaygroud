package com.jimsp.playgroud.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("JHipsterPlaygroud");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("JHipsterPlaygroud");
        ...
        config.getMapConfigs().put("com.jimsp.playgroud.domain.*", initializeDomainMapConfig(jHipsterProperties));
